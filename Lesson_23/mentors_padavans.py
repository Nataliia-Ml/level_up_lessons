...
class Developer:
    def __init__(self, name, dob, profile, salary):
        self.name = name
        self.dob = dob
...
class Junior(Developer):
    def __init__(self, name, dob, salary, profile="Python", mentor=None, plan="Junior plan"):
        super().__init__(name, dob, profile, salary)
...
class Senior(Developer):
    def __init__(self, name, dob, salary, profile="Python", padavans=None):
        super().__init__(name, dob, profile, salary)
